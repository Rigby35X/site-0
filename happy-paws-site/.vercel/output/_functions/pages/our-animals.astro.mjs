...
import 'kleur/colors';
import { $ as $$BaseLayout } from '../chunks/BaseLayout_DLrlr2sT.mjs';
import { $ as $$CTA } from '../chunks/CTA_DO8n3P-Q.mjs';
import { a as getAvailableAnimals } from '../chunks/xano_sqU2RePX.mjs';
/* empty css                                       */
...
</p> </div> </section>    <section id="animal-filters" data-astro-cid-mlfvg3q5> <div class="cs-container" data-astro-cid-mlfvg3q5> <div class="cs-filter-group" data-astro-cid-mlfvg3q5> <button class="cs-filter-button active" data-filter="all" data-astro-cid-mlfvg3q5>All Animals</button> <button class="cs-filter-button" data-filter="dogs" data-astro-cid-mlfvg3q5>Dogs</button> <button class="cs-filter-button" data-filter="cats" data-astro-cid-mlfvg3q5>Cats</button> <button class="cs-filter-button" data-filter="available" data-astro-cid-mlfvg3q5>Available</button> <button class="cs-filter-button" data-filter="special-needs" data-astro-cid-mlfvg3q5>Special Needs</button> </div> </div> </section>    <section id="animal-grid" data-astro-cid-mlfvg3q5> <div class="cs-container" data-astro-cid-mlfvg3q5> <div class="cs-card-group" data-astro-cid-mlfvg3q5> ${animals.map((animal) => renderTemplate`<div class="cs-item"${addAttribute(`${animal.type.toLowerCase()} ${animal.status.toLowerCase()} ${animal.specialNeeds ? "special-needs" : ""}`, "data-category")} data-astro-cid-mlfvg3q5> <picture class="cs-picture" data-astro-cid-mlfvg3q5> <img loading="lazy" decoding="async"${addAttribute(animal.image, "src")}${addAttribute(animal.name, "alt")} width="400" height="300" data-astro-cid-mlfvg3q5> <div class="cs-status-badge cs-status-{animal.status.toLowerCase()}" data-astro-cid-mlfvg3q5> ${animal.status} </div> </picture> <div class="cs-item-content" data-astro-cid-mlfvg3q5> <h3 class="cs-item-title" data-astro-cid-mlfvg3q5>${animal.name}</h3> <div class="cs-item-details" data-astro-cid-mlfvg3q5> <span class="cs-detail" data-astro-cid-mlfvg3q5>${animal.breed}</span> <span class="cs-detail" data-astro-cid-mlfvg3q5>${animal.age}</span> <span class="cs-detail" data-astro-cid-mlfvg3q5>${animal.gender}</span> <span class="cs-detail" data-astro-cid-mlfvg3q5>${animal.size}</span> </div> <p class="cs-item-text" data-astro-cid-mlfvg3q5>${animal.description}</p> <div class="cs-compatibility" data-astro-cid-mlfvg3q5> <h4 data-astro-cid-mlfvg3q5>Good with:</h4> <div class="cs-compatibility-tags" data-astro-cid-mlfvg3q5> ${animal.goodWithKids && renderTemplate`<span class="cs-tag" data-astro-cid-mlfvg3q5>Kids</span>`} ${animal.goodWithCats && renderTemplate`<span class="cs-tag" data-astro-cid-mlfvg3q5>Cats</span>`} ${animal.goodWithDogs && renderTemplate`<span class="cs-tag" data-astro-cid-mlfvg3q5>Dogs</span>`} </div> </div> <div class="cs-button-group" data-astro-cid-mlfvg3q5> <a${addAttribute(`/animal-details/${animal.id}`, "href")} class="cs-button-solid" data-astro-cid-mlfvg3q5>Learn More</a> <a href="/applications" class="cs-button-transparent" data-astro-cid-mlfvg3q5>Apply to Adopt</a> </div> </div> </div>`)} </div> <div class="cs-more-info" data-astro-cid-mlfvg3q5> <h2 data-astro-cid-mlfvg3q5>Don't See Your Perfect Match?</h2> <p data-astro-cid-mlfvg3q5>
