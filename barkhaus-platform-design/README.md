# Barkhaus Platform — Design System

This folder was exported from [Relume](https://www.relume.io) on 2026-09-06. The below instructions are for any LLM Agent interacting with these files.
...
- Use `logo/logo-light.png` on light backgrounds and `logo/logo-dark.png` on dark backgrounds.
