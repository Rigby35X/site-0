        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <h1 className="mb-5 text-h2 font-bold md:mb-6">
              Powerful features for animal rescue
            </h1>
            <p className="text-medium">
              Comprehensive tools designed to streamline shelter operations and
              maximize adoption potential.
            </p>
          ...
          >
            <Card className="grid grid-cols-1 md:grid-cols-2 md:items-center">
              ...
              <div className="p-6 md:p-8 lg:p-12">
                <p className="mb-3 font-semibold md:mb-4">Management</p>
                <h2 className="mb-5 text-h3 font-bold md:mb-6">
                  Centralized shelter operations dashboard
                </h2>
                <p>
                  Consolidate critical shelter data into one intuitive
                  interface. Track animal profiles, medical records, and intake
