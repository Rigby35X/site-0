                  ...
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
                      ...
                      <h2 className="mb-5 text-h2 font-bold md:mb-6">
                        Centralize your shelter operations
                      </h2>
                      <p className="text-medium">
                        Track animals, manage records, and simplify daily tasks
                        with our integrated platform. Save time and focus on
                        what matters most.
                      </p>
            ...
            <div className="px-[5%]">
              <div className="container">
                <a href="#" className="flex h-16 w-full items-center underline">
                  ...
                  <h1 className="text-medium font-semibold">Marketing tools</h1>
                </a>
                <div className="py-8 md:py-10 lg:py-12">
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
                      ...
                      <h2 className="mb-5 text-h2 font-bold md:mb-6">
                        Boost your adoption marketing
                      </h2>
                      <p className="text-medium">
                        Create compelling profiles, share stories, and reach
                        more potential adopters through integrated social media
                        and email campaigns.
                      </p>
                      <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                        <Button title="Learn more" variant="secondary">
                ...
                <div className="py-8 md:py-10 lg:py-12">
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
                      ...
                      <h2 className="mb-5 text-h2 font-bold md:mb-6">
                        Improve your adoption process
                      </h2>
                      <p className="text-medium">
                        Monitor adoption rates, track animal journeys, and
                        generate insights to help more animals find their
                        forever homes.
                      </p>
                      <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                        <Button title="Learn more" variant="secondary">
