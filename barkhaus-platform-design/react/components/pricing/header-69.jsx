    ...
    <section className="relative px-[5%] py-16 md:py-24 lg:py-28 scheme-3">
      <div className="relative z-10 container max-w-lg text-center">
        <h1 className="mb-5 text-h1 font-bold text-white md:mb-6">
          Simple pricing for rescues
        </h1>
        <p className="text-medium text-white">
          Powerful tools that grow with your shelter. No hidden fees. No
          complicated contracts. Just straightforward solutions designed to help
          more animals find their forever homes.
        </p>
      </div>
