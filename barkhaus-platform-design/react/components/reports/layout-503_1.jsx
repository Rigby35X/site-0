        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <h1 className="mb-5 text-h2 font-bold md:mb-6">
              Custom reports for your rescue
            </h1>
            <p className="text-medium">
              Design reports that match your unique shelter needs. No two
              rescues are the same, so why should your reports be?
            </p>
            <div className="mt-6 flex items-center justify-center gap-x-4 md:mt-8">
              <Button title="Create template" variant="secondary">
                Create template
              </Button>
              <Button
          ...
          >
            <Card className="grid grid-cols-1 md:grid-cols-2 md:items-center">
              <div className="p-6 md:p-8 lg:p-12">
                <p className="mb-3 font-semibold md:mb-4">Personalization</p>
                <h2 className="mb-5 text-h3 font-bold md:mb-6">
                  Tailored report builder
                </h2>
                <p>
                  Drag and drop interface allows you to create reports that
                  speak directly to your organization's goals and challenges.
                </p>
                <div className="mt-6 flex items-center gap-x-4 md:mt-8">
                  <Button title="Start building" variant="secondary">
                    Start building
                  </Button>
                  <Button
                    title="See examples"
