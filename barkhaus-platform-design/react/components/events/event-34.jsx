      ...
      <div className="container">
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="max-w-lg">
            <p className="mb-3 font-semibold md:mb-4">Deep dive</p>
            <h1 className="mb-5 text-h2 font-bold md:mb-6">Event schedule</h1>
            <p className="text-medium">
              Explore intensive learning sessions designed to empower animal
          ...
          >
            <div className="flex flex-col gap-y-6 md:gap-y-8">
              ...
              <Card className="grid grid-cols-1 items-center gap-8 p-6 sm:gap-4 md:grid-cols-[6rem_max-content_1fr_max-content] md:gap-8 md:p-8">
                ...
                <div className="grid auto-cols-fr grid-cols-1 items-center gap-4 lg:grid-cols-[1fr_.25fr]">
                  <div>
                    <h5 className="text-h5 font-bold">Volunteer management</h5>
                    <div>Williams</div>
                  </div>
                  <div className="flex items-center gap-2 text-small">
                    <LocationOn className="size-6 flex-none text-scheme-text" />
          ...
          >
            <div className="flex flex-col gap-y-6 md:gap-y-8">
              ...
              <Card className="grid grid-cols-1 items-center gap-8 p-6 sm:gap-4 md:grid-cols-[6rem_max-content_1fr_max-content] md:gap-8 md:p-8">
                ...
                <div className="grid auto-cols-fr grid-cols-1 items-center gap-4 lg:grid-cols-[1fr_.25fr]">
                  <div>
                    <h5 className="text-h5 font-bold">Community engagement</h5>
                    <div>Patel</div>
                  </div>
                  <div className="flex items-center gap-2 text-small">
                    <LocationOn className="size-6 flex-none text-scheme-text" />
