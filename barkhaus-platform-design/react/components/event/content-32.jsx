        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[0.5fr_1fr] lg:gap-x-20">
          <div className="order-last lg:order-none">
            <div className="lg:sticky lg:top-20 lg:max-w-xxs">
              <div>
                <div>
                  <h6 className="mb-5 text-medium font-bold md:mb-6">
                    Contributors
                  </h6>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="grow">
                        ...
                        <p className="text-small">
                          Shelter Leadership Director, National Rescue Alliance
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      ...
                      <div className="grow">
                        ...
                        <p className="text-small">
                          Digital Marketing Specialist, Rescue Tech
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      ...
                      <div className="grow">
                        ...
                        <p className="text-small">
                          Community Engagement Strategist, Hope Worldwide
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                  <h6 className="mb-3 text-medium font-bold md:mb-4">
                    Stay updated
                  </h6>
                ...
                <div className="my-8 h-px bg-scheme-border" />
                <div>
                  <p className="text-medium font-bold">Share</p>
