      ...
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <p className="text-medium">
            Tailor your Barkhaus experience to fit your rescue's unique workflow
          </p>
        </div>
        <div className="grid auto-cols-fr gap-6 md:gap-8">
              ...
              <div>
                <div className="mb-5 md:mb-6">
                  <img
                    ...
                    src="https://cdn.jsdelivr.net/npm/@material-symbols/svg-500@latest/rounded/display_settings.svg"
                  />
                </div>
                ...
                <p>
                  Adjust visual themes and layout to match your organization's
                  style
                </p>
              </div>
          ...
          <Card className="grid auto-cols-fr sm:col-span-2 sm:row-span-2 sm:grid-cols-2 lg:col-start-2 lg:row-start-1">
            <div className="block p-6 sm:flex sm:flex-col sm:justify-center md:p-8">
              <div>
                <p className="mb-2 font-semibold">Preferences</p>
                <h2 className="mb-3 text-h4 font-bold md:mb-4">
                  Configure time zone and regional settings
                </h2>
                <p>Sync platform timing with your local rescue operations</p>
              </div>
              <div className="mt-5 md:mt-6">
                <Button
                  title="Configure"
