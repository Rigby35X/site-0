...
export function Testimonial17_2() {
  return (
    <section className="px-[5%] py-16 md:py-24 lg:py-28 scheme-4">
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          <h2 className="mb-5 text-h2 font-bold md:mb-6">Video testimonials</h2>
          <p className="text-medium">
            Watch how Barkhaus transforms animal rescue operations
          </p>
        </div>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <Card className="flex w-full flex-col items-start justify-between p-6 md:p-8">
            ...
            <h5 className="text-medium">
              Our volunteers now spend more time with animals, less on
              paperwork.
            </h5>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              ...
              <div>
                ...
                <p>Volunteer Coordinator, Hope Haven</p>
              </div>
            </div>
          </Card>
          <Card className="flex w-full flex-col items-start justify-between p-6 md:p-8">
            ...
            <h5 className="text-medium">
              Marketing reach expanded beyond our local community.
            </h5>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              <div className="mb-4 size-12 min-h-12 min-w-12 overflow-hidden rounded-full md:mr-4 md:mb-0">
                <img
              ...
              <div>
                ...
                <p>Communications Manager, Rescue Rangers</p>
              </div>
            </div>
          </Card>
          <Card className="flex w-full flex-col items-start justify-between p-6 md:p-8">
            ...
            <h5 className="text-medium">
              We connected with more potential adopters than ever before.
            </h5>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              <div className="mb-4 size-12 min-h-12 min-w-12 overflow-hidden rounded-full md:mr-4 md:mb-0">
                <img
              ...
              <div>
                ...
                <p>Adoption Specialist, Second Chance Shelter</p>
              </div>
            </div>
          </Card>
        </div>
