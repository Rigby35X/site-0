    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28 scheme-4">
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          <h2 className="mb-5 text-h2 font-bold md:mb-6">Impact stories</h2>
          <p className="text-medium">
            Real results from dedicated animal rescue professionals
          </p>
        </div>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <Card className="flex w-full flex-col items-start justify-between p-6 md:p-8">
            ...
            <h5 className="text-medium">
              We streamlined our entire adoption process with Barkhaus in weeks.
            </h5>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              ...
              <div>
                ...
                <p>Executive Director, Coastal Animal Alliance</p>
              </div>
            </div>
          </Card>
          <Card className="flex w-full flex-col items-start justify-between p-6 md:p-8">
            ...
            <h5 className="text-medium">
              Our administrative work reduced by 60% using their platform.
            </h5>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              <div className="mb-4 size-12 min-h-12 min-w-12 overflow-hidden rounded-full md:mr-4 md:mb-0">
                <img
              ...
              <div>
                ...
                <p>Lead Coordinator, Heartland Rescue Center</p>
              </div>
            </div>
          </Card>
          <Card className="flex w-full flex-col items-start justify-between p-6 md:p-8">
            ...
            <h5 className="text-medium">
              Tracking and reporting became simple and intuitive.
            </h5>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              <div className="mb-4 size-12 min-h-12 min-w-12 overflow-hidden rounded-full md:mr-4 md:mb-0">
                <img
              ...
              <div>
                ...
                <p>Technology Director, National Pet Rescue</p>
              </div>
            </div>
          </Card>
        </div>
