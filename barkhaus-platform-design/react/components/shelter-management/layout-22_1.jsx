        ...
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:items-center md:gap-x-12 lg:gap-x-20">
          <div>
            ...
            <h2 className="mb-5 text-h2 font-bold md:mb-6">
              Comprehensive animal care tracking
            </h2>
            <p className="text-medium">
              Monitor each animal's health, medical history, and progress with
              our intuitive tracking system. Ensure every rescue receives
              personalized care.
            </p>
