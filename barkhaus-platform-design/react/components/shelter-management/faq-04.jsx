      ...
      <div className="container max-w-lg">
        <div className="mb-12 text-center md:mb-18 lg:mb-20">
          ...
          <p className="text-medium">
            Get answers to common questions about managing your shelter with
            Barkhaus
          </p>
        </div>
          ...
          <div className="grid items-start justify-items-stretch gap-4">
            <Card>
              ...
              >
                ...
                <AccordionContent className="md:pb-6">
                  Barkhaus offers seamless implementation with dedicated
                  support. Our team provides comprehensive training and
                  migration assistance to ensure a smooth transition for your
                  shelter.
                </AccordionContent>
              </AccordionItem>
            </Card>
            <Card>
              ...
              >
                ...
                <AccordionContent className="md:pb-6">
                  Every shelter is unique. Our platform allows extensive
                  customization to match your specific operational needs and
            ...
            <Card>
              ...
              >
                ...
                <AccordionContent className="md:pb-6">
                  ...
                  protocols. Your animal and donor information remains
            ...
            <Card>
              ...
              >
                ...
                <AccordionContent className="md:pb-6">
                  ...
                  We provide live chat, email, and phone support to resolve any
            ...
            <Card>
              ...
              >
                ...
                <AccordionContent className="md:pb-6">
                  Pricing is flexible and scales with your shelter's size. We
                  offer tiered plans to accommodate small local rescues and
                  large regional organizations.
                </AccordionContent>
              </AccordionItem>
            </Card>
          </div>
