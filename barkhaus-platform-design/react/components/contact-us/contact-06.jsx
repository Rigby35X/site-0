    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28 scheme-3">
      <div className="container grid grid-cols-1 items-start gap-y-12 md:grid-flow-row md:grid-cols-2 md:gap-x-12 lg:grid-flow-col lg:gap-x-20 lg:gap-y-16">
        <div>
          <div className="mb-6 md:mb-8">
            ...
            <p className="text-medium">
              We're here to answer your questions and support your mission.
            </p>
          </div>
          <div className="grid grid-cols-1 gap-4 py-2">
            <div className="flex items-center gap-4">
              <Mail className="size-6 flex-none text-scheme-text" />
              <p>support@barkhaus.com</p>
            </div>
            <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <p>123 Tech Lane, San Francisco, California 94105</p>
            </div>
          </div>
        </div>
        <form className="grid max-w-lg grid-cols-1 grid-rows-[auto_auto] gap-6">
          ...
          <div className="grid w-full items-center">
            <Label className="mb-2">What can we help with?</Label>
            <Select>
              <SelectTrigger>
          ...
          <div className="grid w-full items-center py-3 md:py-4">
            ...
            <RadioGroup className="grid grid-cols-2 gap-x-6 gap-y-3.5">
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="#first_choice">Shelter director</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="second_choice" id="#second_choice" />
                <Label htmlFor="#second_choice">Rescue volunteer</Label>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="#fourth_choice">Potential partner</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="fifth_choice" id="#fifth_choice" />
                <Label htmlFor="#fifth_choice">Donor</Label>
              </div>
              <div className="flex items-center space-x-2">
