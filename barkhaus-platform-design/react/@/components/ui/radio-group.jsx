...
function RadioGroupItem({ id, className, shape = "dot", ...props }) {
    return (<RadioGroupPrimitive.Item data-slot="radio-group-item" id={id} className={cn("aspect-square size-[1.125rem] rounded-full focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50", "border border-neutral-darkest-15 bg-transparent hover:bg-neutral-darkest-5 data-[state=checked]:bg-neutral-darkest data-[state=checked]:text-white alternate:border-white-20 alternate:hover:bg-white-10 alternate:data-[state=checked]:bg-white alternate:data-[state=checked]:text-neutral-darkest", className)} {...props}>
